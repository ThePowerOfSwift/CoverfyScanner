...
import UIKit
import CoverfyScanner

class ViewController: UIViewController, UINavigationControllerDelegate {
    
    lazy var coverfyScanner: CoverfyScanner = {
        let scanner = CoverfyScanner(superview: self.view, videoFrameOption: .fullScreen, applyFilterCallback: nil, ratio: 1.5)
        scanner.configure()
...
extension ViewController: CoverfyScannerDelegate {
